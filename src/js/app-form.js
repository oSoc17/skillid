  ...
  methods: {
    ...
    back: function () {
      ...
      toggleSearchActive: function(){
          this.formControlElements.searchActif = !this.formControlElements.searchActif;
      },
      toggleMetaDataActive: function () {
          this.formControlElements.metaDataActif = !this.formControlElements.metaDataActif;
      },
      togglePersonalizeActive: function() {
          this.formControlElements.personalizeActif = !this.formControlElements.personalizeActif;
      },
